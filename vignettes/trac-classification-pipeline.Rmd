...
<img src="figures/trac_workflow.png" title="plot of chunk unnamed-chunk-3" alt="plot of chunk unnamed-chunk-3" width="400px" />
...
![plot of chunk plot_trac_classification_path](plot_trac_classification_path-1.png)
...
![plot of chunk plot_trac_classification_path_add_covariates](plot_trac_classification_path_add_covariates-1.png)
...
![plot of chunk plot_trac_classification_cv](plot_trac_classification_cv-1.png)
...
![plot of chunk plot_trac_classification_path_add_covariates_cv](plot_trac_classification_path_add_covariates_cv-1.png)
...
![plot of chunk plot_trac_classification_testerr](plot_trac_classification_testerr-1.png)
...
![plot of chunk plot_slc_classification_testerr](plot_slc_classification_testerr-1.png)
...
show_nonzeros(fit[[1]]$alpha[, cvfit$cv[[1]]$i1se]) %>%
  kable()
#> Warning: Expected 7 pieces. Missing pieces filled with `NA` in 2 rows [1, 2].
```
...
<tbody>
  <tr>
   ...
   <td style="text-align:left;">  </td>
   <td style="text-align:right;"> -0.3666121 </td>
  </tr>
  <tr>
   <td style="text-align:left;"> Bacteria </td>
   <td style="text-align:left;"> Firmicutes </td>
